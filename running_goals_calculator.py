def calculator():
    ...
    days_of_shorter_regular_run = days_left - days_of_longer_regular_run - 1
    print(days_of_shorter_regular_run)
    ...
    for j in range(days_of_longer_regular_run):
        print("run", longer_regular_run, "miles on", days_of_the_week[j + 7 - days_left + days_of_shorter_regular_run])
